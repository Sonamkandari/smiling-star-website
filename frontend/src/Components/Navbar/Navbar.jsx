...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      <img src={logo} alt="Smiling Star" className="nav-logo" />
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li className={menu === "home" ? "active" : ""}>
          <AnchorLink href="#home" onClick={() => handleClick("home")}>
            Home
          </AnchorLink>
        </li>

        <li className={menu === "about" ? "active" : ""}>
          <AnchorLink offset={50} href="#about" onClick={() => handleClick("about")}>
            About Us
          </AnchorLink>
        </li>

        <li className={menu === "services" ? "active" : ""}>
          <AnchorLink offset={50} href="#services" onClick={() => handleClick("services")}>
            Services
          </AnchorLink>
        </li>

        <li className={menu === "work" ? "active" : ""}>
          <AnchorLink offset={50} href="#work" onClick={() => handleClick("work")}>
            Our Latest Work
          </AnchorLink>
        </li>

        <li className={menu === "contact" ? "active" : ""}>
          <AnchorLink offset={50} href="#contact" onClick={() => handleClick("contact")}>
            Contact
          </AnchorLink>
        </li>
      </ul>
